import { ResolveEnd, ActivatedRouteSnapshot, RouterStateSnapshot } from '@angular/router';
...
export class CollaboratorService {
  ...
  getCollaboratorDataList(): Promise<any> {
    return new Promise((resolve, reject) => {
      this._httpClient.get(environment.apiUrl + "/api/collaborators", { headers: this.authorizationHeader() })
  ...
  updateData(data: any): Promise<any> {
    return new Promise((resolve, reject) => {
      this._httpClient.post(environment.apiUrl + "/api/collaborators",data, { headers: this.authorizationHeader() })
        .subscribe((response: any) => {
 ...
 deleteData(_id){
  return new Promise((resolve, reject) => {
    this._httpClient.delete(environment.apiUrl + "/api/collaborators/"+_id, { headers: this.authorizationHeader() })
      .subscribe((response: any) => {
        this.getCollaboratorDataList();
        resolve(response.data);
      }, reject);
